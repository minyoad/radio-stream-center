...
const badCode = `            className=\`w-full flex items-center gap          <div className="flex items-center gap-2 md:gap-4 flex-shrink-0">
...
const fixedCode = `            className={\`w-full flex items-center gap-3.5 px-4 py-3 rounded-xl transition text-xs font-semibold \${
              activeTab === "backup" 
...
if (code.includes(badCode)) {
  ...
  console.log("Could not find badCode to replace.");
}
